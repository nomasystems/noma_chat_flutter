...
Releases older than the ones kept in the main `CHANGELOG.md` (pub.dev rejects a `CHANGELOG.md` over its content-length limit, so older entries move here as new ones land).
