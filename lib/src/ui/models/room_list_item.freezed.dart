...
/// the first room load).
 String? get lastMessageSenderName; String? get lastMessageId; ReceiptStatus? get lastMessageReceipt; MessageType? get lastMessageType; String? get lastMessageMimeType; String? get lastMessageFileName; int? get lastMessageDurationMs; bool get lastMessageIsDeleted; String? get lastMessageReactionEmoji; int get unreadCount; bool get muted; bool get pinned; bool get hidden;/// Moderation mute: an admin/owner silenced the current user in this
...
@useResult
$Res call({
 String id, String? name, String? subject, String? avatarUrl, String? lastMessage, DateTime? lastMessageTime, String? lastMessageUserId, String? lastMessageSenderName, String? lastMessageId, ReceiptStatus? lastMessageReceipt, MessageType? lastMessageType, String? lastMessageMimeType, String? lastMessageFileName, int? lastMessageDurationMs, bool lastMessageIsDeleted, String? lastMessageReactionEmoji, int unreadCount, bool muted, bool pinned, bool hidden, bool selfMuted, bool isGroup, bool isAnnouncement, bool? isOnline, PresenceStatus? presenceStatus, String? otherUserId, RoomRole? userRole, int? memberCount, Map<String, dynamic>? custom, Set<String> typingUserIds, String? effectiveDisplayName, bool isParticipating
});
