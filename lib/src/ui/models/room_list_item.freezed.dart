...
@override
int get hashCode => Object.hashAll([runtimeType,id,name,subject,avatarUrl,lastMessage,lastMessageTime,lastMessageUserId,lastMessageSenderName,lastMessageId,lastMessageReceipt,lastMessageType,lastMessageMimeType,lastMessageFileName,lastMessageDurationMs,lastMessageIsDeleted,lastMessageReactionEmoji,unreadCount,unreadMentions,muted,muteUntil,pinned,hidden,selfMuted,isGroup,isAnnouncement,isOnline,presenceStatus,lastSeen,otherUserId,userRole,memberCount,const DeepCollectionEquality().hash(custom),const DeepCollectionEquality().hash(typingUserIds),effectiveDisplayName,isParticipating]);
...
@useResult
$Res call({
 String id, String? name, String? subject, String? avatarUrl, String? lastMessage, DateTime? lastMessageTime, String? lastMessageUserId, String? lastMessageSenderName, String? lastMessageId, ReceiptStatus? lastMessageReceipt, MessageType? lastMessageType, String? lastMessageMimeType, String? lastMessageFileName, int? lastMessageDurationMs, bool lastMessageIsDeleted, String? lastMessageReactionEmoji, int unreadCount, int unreadMentions, bool muted, DateTime? muteUntil, bool pinned, bool hidden, bool selfMuted, bool isGroup, bool isAnnouncement, bool? isOnline, PresenceStatus? presenceStatus, DateTime? lastSeen, String? otherUserId, RoomRole? userRole, int? memberCount, Map<String, dynamic>? custom, Set<String> typingUserIds, String? effectiveDisplayName, bool isParticipating
});
...
@override
int get hashCode => Object.hashAll([runtimeType,id,name,subject,avatarUrl,lastMessage,lastMessageTime,lastMessageUserId,lastMessageSenderName,lastMessageId,lastMessageReceipt,lastMessageType,lastMessageMimeType,lastMessageFileName,lastMessageDurationMs,lastMessageIsDeleted,lastMessageReactionEmoji,unreadCount,unreadMentions,muted,muteUntil,pinned,hidden,selfMuted,isGroup,isAnnouncement,isOnline,presenceStatus,lastSeen,otherUserId,userRole,memberCount,const DeepCollectionEquality().hash(_custom),const DeepCollectionEquality().hash(_typingUserIds),effectiveDisplayName,isParticipating]);
