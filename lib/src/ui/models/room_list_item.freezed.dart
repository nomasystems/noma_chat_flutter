...
@override
int get hashCode => Object.hashAll([runtimeType,id,name,subject,avatarUrl,lastMessage,lastMessageTime,lastMessageUserId,lastMessageSenderName,lastMessageId,lastMessageReceipt,lastMessageType,lastMessageMimeType,lastMessageFileName,lastMessageDurationMs,lastMessageIsDeleted,lastMessageReactionEmoji,lastMessageReactionTargetText,lastMessageReactionTargetType,unreadCount,unreadMentions,muted,muteUntil,pinned,hidden,selfMuted,isGroup,isAnnouncement,isOnline,presenceStatus,lastSeen,otherUserId,userRole,memberCount,const DeepCollectionEquality().hash(custom),const DeepCollectionEquality().hash(typingUserIds),effectiveDisplayName,isParticipating]);

@override
String toString() {
  return 'RoomListItem(id: $id, name: $name, subject: $subject, avatarUrl: $avatarUrl, lastMessage: $lastMessage, lastMessageTime: $lastMessageTime, lastMessageUserId: $lastMessageUserId, lastMessageSenderName: $lastMessageSenderName, lastMessageId: $lastMessageId, lastMessageReceipt: $lastMessageReceipt, lastMessageType: $lastMessageType, lastMessageMimeType: $lastMessageMimeType, lastMessageFileName: $lastMessageFileName, lastMessageDurationMs: $lastMessageDurationMs, lastMessageIsDeleted: $lastMessageIsDeleted, lastMessageReactionEmoji: $lastMessageReactionEmoji, lastMessageReactionTargetText: $lastMessageReactionTargetText, lastMessageReactionTargetType: $lastMessageReactionTargetType, unreadCount: $unreadCount, unreadMentions: $unreadMentions, muted: $muted, muteUntil: $muteUntil, pinned: $pinned, hidden: $hidden, selfMuted: $selfMuted, isGroup: $isGroup, isAnnouncement: $isAnnouncement, isOnline: $isOnline, presenceStatus: $presenceStatus, lastSeen: $lastSeen, otherUserId: $otherUserId, userRole: $userRole, memberCount: $memberCount, custom: $custom, typingUserIds: $typingUserIds, effectiveDisplayName: $effectiveDisplayName, isParticipating: $isParticipating)';
}
...
@override
int get hashCode => Object.hashAll([runtimeType,id,name,subject,avatarUrl,lastMessage,lastMessageTime,lastMessageUserId,lastMessageSenderName,lastMessageId,lastMessageReceipt,lastMessageType,lastMessageMimeType,lastMessageFileName,lastMessageDurationMs,lastMessageIsDeleted,lastMessageReactionEmoji,lastMessageReactionTargetText,lastMessageReactionTargetType,unreadCount,unreadMentions,muted,muteUntil,pinned,hidden,selfMuted,isGroup,isAnnouncement,isOnline,presenceStatus,lastSeen,otherUserId,userRole,memberCount,const DeepCollectionEquality().hash(_custom),const DeepCollectionEquality().hash(_typingUserIds),effectiveDisplayName,isParticipating]);
