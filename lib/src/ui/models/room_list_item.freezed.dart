...
/// preference). Drives the read-only composer via [isReadOnly].
 bool get selfMuted; bool get isGroup; bool get isAnnouncement; bool? get isOnline; PresenceStatus? get presenceStatus;/// Wall-clock time the other 1:1 participant was last seen online,
...
@override
int get hashCode => Object.hashAll([runtimeType,id,name,subject,avatarUrl,lastMessage,lastMessageTime,lastMessageUserId,lastMessageSenderName,lastMessageId,lastMessageReceipt,lastMessageType,lastMessageMimeType,lastMessageFileName,lastMessageDurationMs,lastMessageIsDeleted,lastMessageIsSystem,lastMessageReactionEmoji,lastMessageReactionTargetText,lastMessageReactionTargetType,unreadCount,unreadMentions,muted,muteUntil,pinned,hidden,selfMuted,isGroup,isAnnouncement,isOnline,presenceStatus,lastSeen,otherUserId,userRole,memberCount,const DeepCollectionEquality().hash(_custom),const DeepCollectionEquality().hash(_typingUserIds),effectiveDisplayName,isParticipating]);
