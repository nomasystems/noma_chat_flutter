...
/// never sees an idle controller with no duration and no waveform.
 ...
 TextStyle? get replyPreviewTextStyle;/// Padding around the whole composer row — the band between the
/// screen edges and the first/last button. Defaults to
/// `EdgeInsets.symmetric(horizontal: 16, vertical: 8)`.
 EdgeInsets? get rowPadding;/// Gap between the text field and the buttons on either side of it
/// (attach on the leading edge, send or camera on the trailing one).
/// Defaults to 16.
 double? get iconGap;/// Gap between the two trailing buttons when both are shown — camera
/// and microphone. Defaults to 12.
 double? get secondaryIconGap;/// Padding inside the text field itself. Defaults to
/// `EdgeInsets.symmetric(horizontal: 16, vertical: 8)`.
 EdgeInsets? get fieldContentPadding;/// Trailing inset of the persistent microphone button, which floats
...
as TextStyle?,rowPadding: freezed == rowPadding ? _self.rowPadding : rowPadding // ignore: cast_nullable_to_non_nullable
as EdgeInsets?,iconGap: freezed == iconGap ? _self.iconGap : iconGap // ignore: cast_nullable_to_non_nullable
as double?,secondaryIconGap: freezed == secondaryIconGap ? _self.secondaryIconGap : secondaryIconGap // ignore: cast_nullable_to_non_nullable
as double?,fieldContentPadding: freezed == fieldContentPadding ? _self.fieldContentPadding : fieldContentPadding // ignore: cast_nullable_to_non_nullable
as EdgeInsets?,voiceButtonInset: freezed == voiceButtonInset ? _self.voiceButtonInset : voiceButtonInset // ignore: cast_nullable_to_non_nullable
as double?,
  ));
}
...
/// equal to the trailing side of [rowPadding] or the button will not
/// land on the slot each row reserves for it. Defaults to 16.
@override final  double? voiceButtonInset;
