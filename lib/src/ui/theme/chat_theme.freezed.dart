...
/// lightweight interactive map (e.g. `GoogleMap` in lite mode).
 ...
 BorderRadius? get imageBorderRadius; double? get imageMaxHeight; double? get imageMaxWidth; TextStyle? get imageCaptionStyle; Color? get videoPlayIconColor; Color? get videoPlayIconBackgroundColor; Color? get videoPlaceholderIconColor;/// Ceiling on the height of a video bubble's poster frame. The frame is
...
/// same shape take the same room.
 ...
 Color? get contextMenuHandleColor; Color? get contextMenuDestructiveColor; Color? get scrollToBottomButtonColor; Color? get scrollToBottomIconColor; Color? get attachmentPickerCircleColor; Color? get attachmentPickerIconColor; TextStyle? get attachmentPickerLabelStyle; Color? get imageViewerBackgroundColor; Color? get imageViewerIconColor;// In-app camera capture (`CameraCapturePage`)
 Color? get cameraCaptureBackgroundColor;/// Tint of everything drawn over the preview: close / flip icons, the
/// shutter ring, the elapsed-time text and the error copy.
 Color? get cameraCaptureForegroundColor;/// Fill of the shutter and of the elapsed-time pill while recording.
 Color? get cameraCaptureRecordingColor;/// Translucent backing of the "your clip was lost" notice.
 Color? get cameraCaptureOverlayColor;/// Style of the hint under the shutter and of the interruption notice.
 TextStyle? get cameraCaptureHintStyle;/// Outer diameter of the shutter. Falls back to
/// [RoomDefaults.cameraShutterSize].
 double? get cameraCaptureShutterSize;/// Fill of the "send this shot" button on the capture-review step —
/// the confirmation the shutter lands on before anything is sent.
/// Falls back to [DefaultPalette.cameraCaptureSendButton].
 Color? get cameraCaptureSendButtonColor;/// Style of the review step's Retake label. Falls back to
/// [cameraCaptureHintStyle], and then to the same white-on-black the
/// rest of the capture screen uses.
 TextStyle? get cameraCaptureReviewActionStyle;// Presence dots
...
// `Theme`, unchanged from before these fields existed.
 Color? get galleryAppBarBackgroundColor; Color? get galleryAppBarForegroundColor; Color? get galleryTabIndicatorColor;/// Surface behind the gallery's media / documents / links tabs. Falls
...
/// instead of behind bubbles.
 Color? get galleryBackgroundColor;// In-room message search (`MessageSearchView`). The host owns the
...
/// wallpaper, same reasoning as [galleryBackgroundColor].
 Color? get messageSearchBackgroundColor;/// Fill of the query field. When non-`null` the field is rendered
/// filled; when `null` it keeps the unfilled outlined treatment.
 Color? get messageSearchFieldFillColor;/// Style of the text the user types into the query field.
 TextStyle? get messageSearchFieldTextStyle;/// Style of the query field's placeholder
/// ([ChatUiLocalizations.searchMessages]).
 TextStyle? get messageSearchFieldHintStyle;/// Caret colour inside the query field. Falls back to the ambient
/// Material `TextSelectionTheme`.
 Color? get messageSearchFieldCursorColor;/// Colour of the query field's outline in every state (idle, focused,
/// disabled). Falls back to the ambient Material input decoration.
 Color? get messageSearchFieldBorderColor;/// Corner radius of the query field's outline. Falls back to the
/// square-ish Material `OutlineInputBorder` default.
 BorderRadius? get messageSearchFieldBorderRadius;/// Tint of the leading magnifier and of the trailing clear button.
/// Falls back to the ambient icon theme.
 Color? get messageSearchFieldIconColor;/// Style of a result row's top line — the sender's display name.
 TextStyle? get messageSearchResultTitleStyle;/// Style of a result row's message snippet, for the portions that do
/// **not** match the query.
 TextStyle? get messageSearchResultSnippetStyle;/// Style of the matched substrings inside a result snippet. Falls back
/// to [messageSearchResultSnippetStyle] made bold, so theming only the
/// snippet still yields a legible highlight.
 TextStyle? get messageSearchResultHighlightStyle;/// Style of a result row's trailing timestamp.
 TextStyle? get messageSearchResultTimestampStyle;/// Style of the "no results" copy. Falls back to
/// [emptyStateTitleStyle], keeping search aligned with every other
/// empty surface in the SDK unless it is themed apart.
 TextStyle? get messageSearchEmptyTextStyle;/// Tint of the spinner shown while the first page of results is in
/// flight. Falls back to [ChatInputTheme.sendButtonColor].
 Color? get messageSearchProgressColor;
...
as Color?,cameraCaptureBackgroundColor: freezed == cameraCaptureBackgroundColor ? _self.cameraCaptureBackgroundColor : cameraCaptureBackgroundColor // ignore: cast_nullable_to_non_nullable
as Color?,cameraCaptureForegroundColor: freezed == cameraCaptureForegroundColor ? _self.cameraCaptureForegroundColor : cameraCaptureForegroundColor // ignore: cast_nullable_to_non_nullable
as Color?,cameraCaptureRecordingColor: freezed == cameraCaptureRecordingColor ? _self.cameraCaptureRecordingColor : cameraCaptureRecordingColor // ignore: cast_nullable_to_non_nullable
as Color?,cameraCaptureOverlayColor: freezed == cameraCaptureOverlayColor ? _self.cameraCaptureOverlayColor : cameraCaptureOverlayColor // ignore: cast_nullable_to_non_nullable
as Color?,cameraCaptureHintStyle: freezed == cameraCaptureHintStyle ? _self.cameraCaptureHintStyle : cameraCaptureHintStyle // ignore: cast_nullable_to_non_nullable
as TextStyle?,cameraCaptureShutterSize: freezed == cameraCaptureShutterSize ? _self.cameraCaptureShutterSize : cameraCaptureShutterSize // ignore: cast_nullable_to_non_nullable
as double?,cameraCaptureSendButtonColor: freezed == cameraCaptureSendButtonColor ? _self.cameraCaptureSendButtonColor : cameraCaptureSendButtonColor // ignore: cast_nullable_to_non_nullable
as Color?,cameraCaptureReviewActionStyle: freezed == cameraCaptureReviewActionStyle ? _self.cameraCaptureReviewActionStyle : cameraCaptureReviewActionStyle // ignore: cast_nullable_to_non_nullable
as TextStyle?,presenceAvailableColor: freezed == presenceAvailableColor ? _self.presenceAvailableColor : presenceAvailableColor // ignore: cast_nullable_to_non_nullable
...
as Color?,galleryBackgroundColor: freezed == galleryBackgroundColor ? _self.galleryBackgroundColor : galleryBackgroundColor // ignore: cast_nullable_to_non_nullable
as Color?,messageSearchBackgroundColor: freezed == messageSearchBackgroundColor ? _self.messageSearchBackgroundColor : messageSearchBackgroundColor // ignore: cast_nullable_to_non_nullable
as Color?,messageSearchFieldFillColor: freezed == messageSearchFieldFillColor ? _self.messageSearchFieldFillColor : messageSearchFieldFillColor // ignore: cast_nullable_to_non_nullable
as Color?,messageSearchFieldTextStyle: freezed == messageSearchFieldTextStyle ? _self.messageSearchFieldTextStyle : messageSearchFieldTextStyle // ignore: cast_nullable_to_non_nullable
as TextStyle?,messageSearchFieldHintStyle: freezed == messageSearchFieldHintStyle ? _self.messageSearchFieldHintStyle : messageSearchFieldHintStyle // ignore: cast_nullable_to_non_nullable
as TextStyle?,messageSearchFieldCursorColor: freezed == messageSearchFieldCursorColor ? _self.messageSearchFieldCursorColor : messageSearchFieldCursorColor // ignore: cast_nullable_to_non_nullable
as Color?,messageSearchFieldBorderColor: freezed == messageSearchFieldBorderColor ? _self.messageSearchFieldBorderColor : messageSearchFieldBorderColor // ignore: cast_nullable_to_non_nullable
as Color?,messageSearchFieldBorderRadius: freezed == messageSearchFieldBorderRadius ? _self.messageSearchFieldBorderRadius : messageSearchFieldBorderRadius // ignore: cast_nullable_to_non_nullable
as BorderRadius?,messageSearchFieldIconColor: freezed == messageSearchFieldIconColor ? _self.messageSearchFieldIconColor : messageSearchFieldIconColor // ignore: cast_nullable_to_non_nullable
as Color?,messageSearchResultTitleStyle: freezed == messageSearchResultTitleStyle ? _self.messageSearchResultTitleStyle : messageSearchResultTitleStyle // ignore: cast_nullable_to_non_nullable
as TextStyle?,messageSearchResultSnippetStyle: freezed == messageSearchResultSnippetStyle ? _self.messageSearchResultSnippetStyle : messageSearchResultSnippetStyle // ignore: cast_nullable_to_non_nullable
as TextStyle?,messageSearchResultHighlightStyle: freezed == messageSearchResultHighlightStyle ? _self.messageSearchResultHighlightStyle : messageSearchResultHighlightStyle // ignore: cast_nullable_to_non_nullable
as TextStyle?,messageSearchResultTimestampStyle: freezed == messageSearchResultTimestampStyle ? _self.messageSearchResultTimestampStyle : messageSearchResultTimestampStyle // ignore: cast_nullable_to_non_nullable
as TextStyle?,messageSearchEmptyTextStyle: freezed == messageSearchEmptyTextStyle ? _self.messageSearchEmptyTextStyle : messageSearchEmptyTextStyle // ignore: cast_nullable_to_non_nullable
as TextStyle?,messageSearchProgressColor: freezed == messageSearchProgressColor ? _self.messageSearchProgressColor : messageSearchProgressColor // ignore: cast_nullable_to_non_nullable
as Color?,
  ));
}
/// Create a copy of ChatTheme
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( ChatUiLocalizations l10n,  ChatBubbleTheme bubble,  ChatInputTheme input,  ChatRoomListTheme roomList,  ChatMarkdownTheme markdown,  Widget Function(BuildContext, double latitude, double longitude)? locationMapBuilder,  TextStyle? dateSeparatorTextStyle,  Color? dateSeparatorBackgroundColor,  TextStyle? systemMessageTextStyle,  Color? systemMessageBackgroundColor,  Color? typingIndicatorDotColor,  TextStyle? typingStatusTextStyle,  Color? reactionBackgroundColor,  Color? reactionSelectedColor,  Color? reactionSelectedBorderColor,  TextStyle? reactionTextStyle,  double? reactionPickerElevation,  BorderRadius? reactionPickerBorderRadius,  double? reactionPickerEmojiSize,  Color? reactionDetailSheetBackgroundColor,  TextStyle? reactionDetailUserNameStyle,  Color? reactionDetailRemoveColor,  Color? floatingPickerBackgroundColor,  Color? fullEmojiPickerBackgroundColor,  Color? audioPlayButtonColor,  Color? audioPlayIconColor,  Color? audioSeekBarColor,  Color? audioSeekBarActiveColor,  TextStyle? audioDurationTextStyle,  Color? audioSpeedButtonColor,  TextStyle? audioSpeedTextStyle,  Color? audioListenedIconColor,  Color? audioUnlistenedIconColor,  Color? voiceRecorderActiveColor,  TextStyle? voiceRecorderTimerStyle,  Color? voiceRecorderOverlayColor,  Color? voiceRecorderCancelColor,  Color? voiceRecorderLockIconColor,  TextStyle? voiceRecorderHintStyle,  Color? waveformActiveColor,  Color? waveformInactiveColor,  Color? waveformRecordingColor,  BorderRadius? imageBorderRadius,  double? imageMaxHeight,  double? imageMaxWidth,  TextStyle? imageCaptionStyle,  Color? videoPlayIconColor,  Color? videoPlayIconBackgroundColor,  Color? videoPlaceholderIconColor,  double? videoHeight,  Color? videoPlaceholderColor,  BorderRadius? videoBorderRadius,  Color? fileIconColor,  TextStyle? fileNameTextStyle,  TextStyle? fileSizeTextStyle,  Color? linkPreviewBackgroundColor,  TextStyle? linkPreviewTitleStyle,  TextStyle? linkPreviewDescriptionStyle,  BorderRadius? linkPreviewBorderRadius,  TextStyle? linkPreviewDomainStyle,  Color? linkPreviewBorderColor,  Color? backgroundColor,  ImageProvider? backgroundImage,  ImageRepeat backgroundImageRepeat,  double backgroundImageOpacity,  ColorFilter? backgroundImageColorFilter,  Color? avatarBackgroundColor,  TextStyle? avatarInitialsTextStyle,  Color? avatarOnlineColor,  Color? avatarOfflineColor,  Color? avatarOnlineBorderColor,  Color? connectionBannerColor,  TextStyle? connectionBannerTextStyle,  Color? connectionBannerErrorIconColor,  Color? emptyStateIconColor,  TextStyle? emptyStateTitleStyle,  TextStyle? emptyStateSubtitleStyle,  Color? contextMenuHandleColor,  Color? contextMenuDestructiveColor,  Color? scrollToBottomButtonColor,  Color? scrollToBottomIconColor,  Color? attachmentPickerCircleColor,  Color? attachmentPickerIconColor,  TextStyle? attachmentPickerLabelStyle,  Color? imageViewerBackgroundColor,  Color? imageViewerIconColor,  Color? cameraCaptureBackgroundColor,  Color? cameraCaptureForegroundColor,  Color? cameraCaptureRecordingColor,  Color? cameraCaptureOverlayColor,  TextStyle? cameraCaptureHintStyle,  double? cameraCaptureShutterSize,  Color? cameraCaptureSendButtonColor,  TextStyle? cameraCaptureReviewActionStyle,  Color? presenceAvailableColor,  Color? presenceAwayColor,  Color? presenceBusyColor,  Color? presenceDndColor,  Color? galleryAppBarBackgroundColor,  Color? galleryAppBarForegroundColor,  Color? galleryTabIndicatorColor,  Color? galleryBackgroundColor,  Color? messageSearchBackgroundColor,  Color? messageSearchFieldFillColor,  TextStyle? messageSearchFieldTextStyle,  TextStyle? messageSearchFieldHintStyle,  Color? messageSearchFieldCursorColor,  Color? messageSearchFieldBorderColor,  BorderRadius? messageSearchFieldBorderRadius,  Color? messageSearchFieldIconColor,  TextStyle? messageSearchResultTitleStyle,  TextStyle? messageSearchResultSnippetStyle,  TextStyle? messageSearchResultHighlightStyle,  TextStyle? messageSearchResultTimestampStyle,  TextStyle? messageSearchEmptyTextStyle,  Color? messageSearchProgressColor)  $default,) {final _that = this;
switch (_that) {
case _ChatTheme():
return $default(_that.l10n,_that.bubble,_that.input,_that.roomList,_that.markdown,_that.locationMapBuilder,_that.dateSeparatorTextStyle,_that.dateSeparatorBackgroundColor,_that.systemMessageTextStyle,_that.systemMessageBackgroundColor,_that.typingIndicatorDotColor,_that.typingStatusTextStyle,_that.reactionBackgroundColor,_that.reactionSelectedColor,_that.reactionSelectedBorderColor,_that.reactionTextStyle,_that.reactionPickerElevation,_that.reactionPickerBorderRadius,_that.reactionPickerEmojiSize,_that.reactionDetailSheetBackgroundColor,_that.reactionDetailUserNameStyle,_that.reactionDetailRemoveColor,_that.floatingPickerBackgroundColor,_that.fullEmojiPickerBackgroundColor,_that.audioPlayButtonColor,_that.audioPlayIconColor,_that.audioSeekBarColor,_that.audioSeekBarActiveColor,_that.audioDurationTextStyle,_that.audioSpeedButtonColor,_that.audioSpeedTextStyle,_that.audioListenedIconColor,_that.audioUnlistenedIconColor,_that.voiceRecorderActiveColor,_that.voiceRecorderTimerStyle,_that.voiceRecorderOverlayColor,_that.voiceRecorderCancelColor,_that.voiceRecorderLockIconColor,_that.voiceRecorderHintStyle,_that.waveformActiveColor,_that.waveformInactiveColor,_that.waveformRecordingColor,_that.imageBorderRadius,_that.imageMaxHeight,_that.imageMaxWidth,_that.imageCaptionStyle,_that.videoPlayIconColor,_that.videoPlayIconBackgroundColor,_that.videoPlaceholderIconColor,_that.videoHeight,_that.videoPlaceholderColor,_that.videoBorderRadius,_that.fileIconColor,_that.fileNameTextStyle,_that.fileSizeTextStyle,_that.linkPreviewBackgroundColor,_that.linkPreviewTitleStyle,_that.linkPreviewDescriptionStyle,_that.linkPreviewBorderRadius,_that.linkPreviewDomainStyle,_that.linkPreviewBorderColor,_that.backgroundColor,_that.backgroundImage,_that.backgroundImageRepeat,_that.backgroundImageOpacity,_that.backgroundImageColorFilter,_that.avatarBackgroundColor,_that.avatarInitialsTextStyle,_that.avatarOnlineColor,_that.avatarOfflineColor,_that.avatarOnlineBorderColor,_that.connectionBannerColor,_that.connectionBannerTextStyle,_that.connectionBannerErrorIconColor,_that.emptyStateIconColor,_that.emptyStateTitleStyle,_that.emptyStateSubtitleStyle,_that.contextMenuHandleColor,_that.contextMenuDestructiveColor,_that.scrollToBottomButtonColor,_that.scrollToBottomIconColor,_that.attachmentPickerCircleColor,_that.attachmentPickerIconColor,_that.attachmentPickerLabelStyle,_that.imageViewerBackgroundColor,_that.imageViewerIconColor,_that.cameraCaptureBackgroundColor,_that.cameraCaptureForegroundColor,_that.cameraCaptureRecordingColor,_that.cameraCaptureOverlayColor,_that.cameraCaptureHintStyle,_that.cameraCaptureShutterSize,_that.cameraCaptureSendButtonColor,_that.cameraCaptureReviewActionStyle,_that.presenceAvailableColor,_that.presenceAwayColor,_that.presenceBusyColor,_that.presenceDndColor,_that.galleryAppBarBackgroundColor,_that.galleryAppBarForegroundColor,_that.galleryTabIndicatorColor,_that.galleryBackgroundColor,_that.messageSearchBackgroundColor,_that.messageSearchFieldFillColor,_that.messageSearchFieldTextStyle,_that.messageSearchFieldHintStyle,_that.messageSearchFieldCursorColor,_that.messageSearchFieldBorderColor,_that.messageSearchFieldBorderRadius,_that.messageSearchFieldIconColor,_that.messageSearchResultTitleStyle,_that.messageSearchResultSnippetStyle,_that.messageSearchResultHighlightStyle,_that.messageSearchResultTimestampStyle,_that.messageSearchEmptyTextStyle,_that.messageSearchProgressColor);case _:
  throw StateError('Unexpected subclass');
...
/// reads as a stray grey panel once it sits behind a plain tabbed list
/// instead of behind bubbles.
@override final  Color? galleryBackgroundColor;
...
/// Deliberately **not** [backgroundColor]: that one is the chat
/// wallpaper, same reasoning as [galleryBackgroundColor].
@override final  Color? messageSearchBackgroundColor;
/// Fill of the query field. When non-`null` the field is rendered
/// filled; when `null` it keeps the unfilled outlined treatment.
@override final  Color? messageSearchFieldFillColor;
/// Style of the text the user types into the query field.
@override final  TextStyle? messageSearchFieldTextStyle;
/// Style of the query field's placeholder
/// ([ChatUiLocalizations.searchMessages]).
@override final  TextStyle? messageSearchFieldHintStyle;
/// Caret colour inside the query field. Falls back to the ambient
/// Material `TextSelectionTheme`.
@override final  Color? messageSearchFieldCursorColor;
/// Colour of the query field's outline in every state (idle, focused,
/// disabled). Falls back to the ambient Material input decoration.
@override final  Color? messageSearchFieldBorderColor;
/// Corner radius of the query field's outline. Falls back to the
/// square-ish Material `OutlineInputBorder` default.
@override final  BorderRadius? messageSearchFieldBorderRadius;
/// Tint of the leading magnifier and of the trailing clear button.
/// Falls back to the ambient icon theme.
@override final  Color? messageSearchFieldIconColor;
/// Style of a result row's top line — the sender's display name.
@override final  TextStyle? messageSearchResultTitleStyle;
/// Style of a result row's message snippet, for the portions that do
/// **not** match the query.
@override final  TextStyle? messageSearchResultSnippetStyle;
/// Style of the matched substrings inside a result snippet. Falls back
/// to [messageSearchResultSnippetStyle] made bold, so theming only the
/// snippet still yields a legible highlight.
@override final  TextStyle? messageSearchResultHighlightStyle;
/// Style of a result row's trailing timestamp.
@override final  TextStyle? messageSearchResultTimestampStyle;
/// Style of the "no results" copy. Falls back to
/// [emptyStateTitleStyle], keeping search aligned with every other
/// empty surface in the SDK unless it is themed apart.
@override final  TextStyle? messageSearchEmptyTextStyle;
/// Tint of the spinner shown while the first page of results is in
/// flight. Falls back to [ChatInputTheme.sendButtonColor].
@override final  Color? messageSearchProgressColor;
