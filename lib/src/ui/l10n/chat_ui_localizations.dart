...
///
/// Provides pre-built [en], [es], [fr], [de], [it], [pt], [ca], [sv], [no],
/// [da], [pl] and [cs] constants. Create a custom instance or use
/// [copyWith] to override individual strings for other languages.
///
/// [sv], [no], [da], [pl] and [cs] cover the ~160 highest-traffic strings
/// with native translations; fields outside that set fall back to the
...
class ChatUiLocalizations {
  ...
  /// Tappable footer row shown by [GroupMembersView] in `embedded` mode
  ...
  // no silent mistranslation, just an explicit, documented gap. See
  // CONVENTIONS.md / TESTING.md (noma-chat docs front) for the exact list
  // of covered vs. English-fallback fields per locale before shipping to
  // production in these languages.
  // ----------------------------------------------------------------

  static const ChatUiLocalizations sv = ChatUiLocalizations(
    localeCode: 'sv',
    today: 'Idag',
    yesterday: 'Igår',
    ...
    allReactions: 'Alla',
    moreEmojis: 'Fler emojier',
    you: 'Du',
    manage: 'Hantera',
    more: 'Mer',
    pinned: 'Fäst',
    pinnedMessages: 'Fästa meddelanden',
    noPinnedMessages: 'Inga fästa meddelanden',
    reported: 'Anmäld',
    reportMessageTitle: 'Anmäl meddelande',
    feedbackMessagePinned: 'Meddelande fäst',
    feedbackMessageUnpinned: 'Fäst borttagen',
    feedbackMessageDeleted: 'Meddelande borttaget',
    create: 'Skapa',
    newGroup: 'Ny grupp',
    logout: 'Logga ut',
    invitationRejected: 'Inbjudan avvisad',
    ...
    send: 'Skicka',
    recordVoice: 'Spela in röstmeddelande',
    loading: 'Laddar...',
    noMessages: 'Inga meddelanden än',
    imagePreview: 'Foto',
    videoPreview: 'Video',
    attachmentPreview: '📎 Bilaga',
    ...
    previewVideoCaptionTemplate: '📹 {caption}',
    previewGif: '📷 GIF',
    previewVoiceTemplate: '🎤 Röstmeddelande ({duration})',
    previewAudioFileTemplate: '🎵 {name}',
    previewDocumentTemplate: '📄 {name}',
    previewLocation: '📍 Plats',
    previewContactTemplate: '👤 {name}',
    previewSticker: 'Dekal',
    previewDeletedByYou: 'Du tog bort detta meddelande',
    previewDeletedByOther: 'Detta meddelande togs bort',
    previewYouPrefix: 'Du',
    reactionPreviewTemplate: 'Reagerade {emoji}',
    reactionPreviewSelfTemplate: 'Du reagerade {emoji} på "{message}"',
    reactionPreviewOtherTemplate: '{name} reagerade {emoji} på "{message}"',
    galleryTitle: 'Delat i den här chatten',
    galleryMediaTab: 'Media',
    galleryDocsTab: 'Dokument',
    galleryLinksTab: 'Länkar',
    ...
    members: 'medlemmar',
    thread: 'Tråd',
    replyQuoteSemanticsTemplate: 'Svar till {sender}: {quote}',
    replyQuoteSemanticsNoSenderTemplate: 'Svar på: {quote}',
    ...
    editGroupInfo: 'Redigera gruppinfo',
    groupName: 'Gruppnamn',
    save: 'Spara',
    ...
    readBy: 'Läst av',
    deliveredTo: 'Levererat till',
    messageSentAtTemplate: 'Skickat \u00b7 {time}',
    messageSentNoReceiptsTemplate:
        'Skickat kl. {time}. Ingen har tagit emot det än.',
    exportChat: 'Exportera chatt',
    star: 'Stjärnmärk',
    unstar: 'Ta bort stjärnmärkning',
    starredMessages: 'Stjärnmärkta meddelanden',
    noStarredMessages: 'Inga stjärnmärkta meddelanden än',
    muteDuration: 'Tysta aviseringar',
    mute8Hours: '8 timmar',
    mute1Week: '1 vecka',
    muteAlways: 'Alltid',
  ...
  static const ChatUiLocalizations no = ChatUiLocalizations(
    localeCode: 'no',
    today: 'I dag',
    yesterday: 'I går',
    ...
    reported: 'Rapportert',
    reportMessageTitle: 'Rapporter melding',
    feedbackMessagePinned: 'Melding festet',
    feedbackMessageUnpinned: 'Feste fjernet',
    feedbackMessageDeleted: 'Melding slettet',
    create: 'Opprett',
    newGroup: 'Ny gruppe',
    logout: 'Logg ut',
    invitationRejected: 'Invitasjon avvist',
    ...
    send: 'Send',
    recordVoice: 'Ta opp talemelding',
    loading: 'Laster...',
    noMessages: 'Ingen meldinger ennå',
    imagePreview: 'Bilde',
    videoPreview: 'Video',
    attachmentPreview: '📎 Vedlegg',
    audioPreview: '🎤 Talemelding',
    previewPhoto: '📷 Bilde',
    previewPhotoCaptionTemplate: '📷 {caption}',
    previewVideo: '📹 Video',
    previewVideoCaptionTemplate: '📹 {caption}',
    previewGif: '📷 GIF',
    previewVoiceTemplate: '🎤 Talemelding ({duration})',
    previewAudioFileTemplate: '🎵 {name}',
    previewDocumentTemplate: '📄 {name}',
    previewLocation: '📍 Posisjon',
    previewContactTemplate: '👤 {name}',
    previewSticker: 'Klistremerke',
    previewDeletedByYou: 'Du slettet denne meldingen',
    previewDeletedByOther: 'Denne meldingen ble slettet',
    previewYouPrefix: 'Du',
    reactionPreviewTemplate: 'Reagerte {emoji}',
    reactionPreviewSelfTemplate: 'Du reagerte {emoji} på "{message}"',
    reactionPreviewOtherTemplate: '{name} reagerte {emoji} på "{message}"',
    galleryTitle: 'Delt i denne chatten',
    galleryMediaTab: 'Media',
    galleryDocsTab: 'Dokumenter',
    galleryLinksTab: 'Lenker',
    ...
    members: 'medlemmer',
    thread: 'Tråd',
    replyQuoteSemanticsTemplate: 'Svar til {sender}: {quote}',
    replyQuoteSemanticsNoSenderTemplate: 'Svar på: {quote}',
    ...
    selectContacts: 'Velg kontakter',
    noContactsAvailable: 'Ingen kontakter tilgjengelig',
    groupMembers: 'Gruppemedlemmer',
    makeAdmin: 'Gjør til admin',
    removeAdmin: 'Fjern admin',
    leaveGroup: 'Forlat gruppen',
    editGroupInfo: 'Rediger gruppeinfo',
    ...
    messageSentAtTemplate: 'Sendt \u00b7 {time}',
    messageSentNoReceiptsTemplate:
        'Sendt kl. {time}. Ingen har mottatt den ennå.',
    exportChat: 'Eksporter chat',
    star: 'Stjernemerk',
    unstar: 'Fjern stjernemerking',
    starredMessages: 'Stjernemerkede meldinger',
    noStarredMessages: 'Ingen stjernemerkede meldinger ennå',
    muteDuration: 'Demp varsler',
    mute8Hours: '8 timer',
    mute1Week: '1 uke',
    muteAlways: 'Alltid',
  ...
  static const ChatUiLocalizations da = ChatUiLocalizations(
    localeCode: 'da',
    today: 'I dag',
    yesterday: 'I går',
    ...
    more: 'Mere',
    pinned: 'Fastgjort',
    pinnedMessages: 'Fastgjorte beskeder',
    noPinnedMessages: 'Ingen fastgjorte beskeder',
    reported: 'Anmeldt',
    reportMessageTitle: 'Anmeld besked',
    feedbackMessagePinned: 'Besked fastgjort',
    feedbackMessageUnpinned: 'Fastgørelse fjernet',
    feedbackMessageDeleted: 'Besked slettet',
    create: 'Opret',
    newGroup: 'Ny gruppe',
    logout: 'Log ud',
    invitationRejected: 'Invitation afvist',
    forwardTo: 'Videresend til…',
    ...
    send: 'Send',
    recordVoice: 'Optag talebesked',
    loading: 'Indlæser...',
    noMessages: 'Ingen beskeder endnu',
    imagePreview: 'Foto',
    videoPreview: 'Video',
    attachmentPreview: '📎 Vedhæftet fil',
    ...
    previewVideoCaptionTemplate: '📹 {caption}',
    previewGif: '📷 GIF',
    previewVoiceTemplate: '🎤 Talebesked ({duration})',
    previewAudioFileTemplate: '🎵 {name}',
    previewDocumentTemplate: '📄 {name}',
    previewLocation: '📍 Placering',
    previewContactTemplate: '👤 {name}',
    previewSticker: 'Klistermærke',
    previewDeletedByYou: 'Du slettede denne besked',
    previewDeletedByOther: 'Denne besked blev slettet',
    previewYouPrefix: 'Du',
    reactionPreviewTemplate: 'Reagerede {emoji}',
    reactionPreviewSelfTemplate: 'Du reagerede {emoji} på "{message}"',
    reactionPreviewOtherTemplate: '{name} reagerede {emoji} på "{message}"',
    galleryTitle: 'Delt i denne chat',
    galleryMediaTab: 'Medier',
    galleryDocsTab: 'Dokumenter',
    galleryLinksTab: 'Links',
    ...
    selectContacts: 'Vælg kontakter',
    noContactsAvailable: 'Ingen kontakter tilgængelige',
    groupMembers: 'Gruppemedlemmer',
    makeAdmin: 'Gør til admin',
    removeAdmin: 'Fjern admin',
    leaveGroup: 'Forlad gruppen',
    editGroupInfo: 'Rediger gruppeoplysninger',
    groupName: 'Gruppenavn',
    save: 'Gem',
    changeAvatar: 'Skift profilbillede',
    takePhoto: 'Tag foto',
    chooseFromGallery: 'Vælg fra galleri',
    viewPhoto: 'Vis foto',
    removePhoto: 'Fjern foto',
    profilePhoto: 'Profilbillede',
    groupPhoto: 'Gruppebillede',
    ...
    about: 'Om',
    groupDescription: 'Beskrivelse',
    groupInfo: 'Gruppeoplysninger',
    createGroup: 'Opret gruppe',
    next: 'Næste',
    messageInfo: 'Beskedoplysninger',
    readBy: 'Læst af',
    deliveredTo: 'Leveret til',
    messageSentAtTemplate: 'Sendt \u00b7 {time}',
    messageSentNoReceiptsTemplate:
        'Sendt kl. {time}. Ingen har modtaget den endnu.',
    exportChat: 'Eksporter chat',
    star: 'Stjernemarkér',
    unstar: 'Fjern stjernemarkering',
    starredMessages: 'Stjernemarkerede beskeder',
    noStarredMessages: 'Ingen stjernemarkerede beskeder endnu',
    muteDuration: 'Slå notifikationer fra',
    mute8Hours: '8 timer',
    mute1Week: '1 uge',
    muteAlways: 'Altid',
    ...
    presenceAway: 'Fraværende',
    presenceBusy: 'Optaget',
    presenceDnd: 'Forstyr ikke',
    presenceOffline: 'Offline',
    email: 'E-mail',
  ...
  static const ChatUiLocalizations pl = ChatUiLocalizations(
    localeCode: 'pl',
    today: 'Dzisiaj',
    yesterday: 'Wczoraj',
    ...
    allReactions: 'Wszystkie',
    moreEmojis: 'Więcej emoji',
    you: 'Ty',
    manage: 'Zarządzaj',
    more: 'Więcej',
    pinned: 'Przypięte',
    ...
    reported: 'Zgłoszono',
    reportMessageTitle: 'Zgłoś wiadomość',
    feedbackMessagePinned: 'Wiadomość przypięta',
    feedbackMessageUnpinned: 'Wiadomość odpięta',
    feedbackMessageDeleted: 'Wiadomość usunięta',
    create: 'Utwórz',
    newGroup: 'Nowa grupa',
    logout: 'Wyloguj',
    invitationRejected: 'Zaproszenie odrzucone',
    ...
    imagePreview: 'Zdjęcie',
    videoPreview: 'Wideo',
    attachmentPreview: '📎 Załącznik',
    audioPreview: '🎤 Wiadomość głosowa',
    previewPhoto: '📷 Zdjęcie',
    previewPhotoCaptionTemplate: '📷 {caption}',
    previewVideo: '📹 Wideo',
    previewVideoCaptionTemplate: '📹 {caption}',
    previewGif: '📷 GIF',
    previewVoiceTemplate: '🎤 Wiadomość głosowa ({duration})',
    previewAudioFileTemplate: '🎵 {name}',
    previewDocumentTemplate: '📄 {name}',
    previewLocation: '📍 Lokalizacja',
    previewContactTemplate: '👤 {name}',
    previewSticker: 'Naklejka',
    previewDeletedByYou: 'Wiadomość usunięta przez Ciebie',
    previewDeletedByOther: 'Ta wiadomość została usunięta',
    previewYouPrefix: 'Ty',
    reactionPreviewTemplate: 'Reakcja {emoji}',
    reactionPreviewSelfTemplate: 'Twoja reakcja {emoji} na "{message}"',
    reactionPreviewOtherTemplate: 'Reakcja {emoji} od {name} na "{message}"',
    galleryTitle: 'Udostępnione w tym czacie',
    galleryMediaTab: 'Media',
    galleryDocsTab: 'Dokumenty',
    galleryLinksTab: 'Linki',
    ...
    members: 'członkowie',
    thread: 'Wątek',
    replyQuoteSemanticsTemplate: 'Odpowiedź do {sender}: {quote}',
    replyQuoteSemanticsNoSenderTemplate: 'Odpowiedź na: {quote}',
    ...
    messageSentAtTemplate: 'Wysłano \u00b7 {time}',
    messageSentNoReceiptsTemplate:
        'Wysłano o {time}. Nikt jeszcze nie odebrał tej wiadomości.',
    exportChat: 'Eksportuj czat',
    star: 'Oznacz gwiazdką',
    unstar: 'Usuń oznaczenie gwiazdką',
    starredMessages: 'Wiadomości oznaczone gwiazdką',
    noStarredMessages: 'Brak wiadomości oznaczonych gwiazdką',
    muteDuration: 'Wycisz powiadomienia',
    mute8Hours: '8 godzin',
    mute1Week: '1 tydzień',
    muteAlways: 'Zawsze',
  ...
  static const ChatUiLocalizations cs = ChatUiLocalizations(
    localeCode: 'cs',
    today: 'Dnes',
    yesterday: 'Včera',
    ...
    react: 'Reagovat',
    reactions: 'Reakce',
    removeReaction: 'Odebrat reakci',
    allReactions: 'Vše',
    moreEmojis: 'Další emoji',
    you: 'Ty',
    manage: 'Spravovat',
    more: 'Více',
    pinned: 'Připnuto',
    pinnedMessages: 'Připnuté zprávy',
    noPinnedMessages: 'Žádné připnuté zprávy',
    reported: 'Nahlášeno',
    reportMessageTitle: 'Nahlásit zprávu',
    feedbackMessagePinned: 'Zpráva připnuta',
    feedbackMessageUnpinned: 'Zpráva odepnuta',
    feedbackMessageDeleted: 'Zpráva smazána',
    create: 'Vytvořit',
    newGroup: 'Nová skupina',
    logout: 'Odhlásit se',
    invitationRejected: 'Pozvánka odmítnuta',
    ...
    imagePreview: 'Fotka',
    videoPreview: 'Video',
    attachmentPreview: '📎 Příloha',
    audioPreview: '🎤 Hlasová zpráva',
    previewPhoto: '📷 Fotka',
    previewPhotoCaptionTemplate: '📷 {caption}',
    previewVideo: '📹 Video',
    previewVideoCaptionTemplate: '📹 {caption}',
    previewGif: '📷 GIF',
    previewVoiceTemplate: '🎤 Hlasová zpráva ({duration})',
    previewAudioFileTemplate: '🎵 {name}',
    previewDocumentTemplate: '📄 {name}',
    previewLocation: '📍 Poloha',
    previewContactTemplate: '👤 {name}',
    previewSticker: 'Samolepka',
    previewDeletedByYou: 'Tuto zprávu jste smazali',
    previewDeletedByOther: 'Tato zpráva byla smazána',
    previewYouPrefix: 'Vy',
    reactionPreviewTemplate: 'Reakce {emoji}',
    reactionPreviewSelfTemplate: 'Vaše reakce {emoji} na "{message}"',
    reactionPreviewOtherTemplate: 'Reakce {emoji} od {name} na "{message}"',
    galleryTitle: 'Sdíleno v tomto chatu',
    galleryMediaTab: 'Média',
    galleryDocsTab: 'Dokumenty',
    galleryLinksTab: 'Odkazy',
    ...
    members: 'členové',
    thread: 'Vlákno',
    replyQuoteSemanticsTemplate: 'Odpověď pro {sender}: {quote}',
    replyQuoteSemanticsNoSenderTemplate: 'Odpověď na: {quote}',
    ...
    blockedUsersEmpty: 'Žádní blokovaní uživatelé',
    unblock: 'Odblokovat',
    addMembers: 'Přidat členy',
    selectContacts: 'Vybrat kontakty',
    noContactsAvailable: 'Žádné dostupné kontakty',
    groupMembers: 'Členové skupiny',
    makeAdmin: 'Nastavit jako správce',
    removeAdmin: 'Odebrat správce',
    leaveGroup: 'Opustit skupinu',
    editGroupInfo: 'Upravit informace o skupině',
    ...
    messageSentAtTemplate: 'Odesláno \u00b7 {time}',
    messageSentNoReceiptsTemplate:
        'Odesláno v {time}. Zatím to nikdo neobdržel.',
    exportChat: 'Exportovat chat',
    star: 'Označit hvězdičkou',
    unstar: 'Zrušit označení hvězdičkou',
    starredMessages: 'Zprávy s hvězdičkou',
    noStarredMessages: 'Zatím žádné zprávy s hvězdičkou',
    muteDuration: 'Ztlumit oznámení',
    mute8Hours: '8 hodin',
    mute1Week: '1 týden',
    muteAlways: 'Vždy',
    ...
    presenceAvailable: 'Dostupný',
    presenceAway: 'Pryč',
    presenceBusy: 'Zaneprázdněn',
    presenceDnd: 'Nerušit',
    presenceOffline: 'Offline',
    email: 'E-mail',
