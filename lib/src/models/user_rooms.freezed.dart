...
class _UserRooms implements UserRooms {
  const _UserRooms({required final  List<UnreadRoom> rooms, final  List<InvitedRoom> invitedRooms = const <InvitedRoom>[], this.hasMore = false}): _rooms = rooms,_invitedRooms = invitedRooms;
