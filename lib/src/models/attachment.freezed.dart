...
@override
String toString() {
  return 'AttachmentUploadResult(attachmentId: $attachmentId, url: $url, metadata: $metadata, raw: $raw)';
}
...
class _AttachmentUploadResult implements AttachmentUploadResult {
  const _AttachmentUploadResult({required this.attachmentId, this.url, this.metadata, required final  Map<String, dynamic> raw}): _raw = raw;
...
/// @nodoc
mixin _$AttachmentSignedUrl {

 String get url; Map<String, dynamic> get raw;
/// Create a copy of AttachmentSignedUrl
/// with the given fields replaced by the non-null parameter values.
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$AttachmentSignedUrlCopyWith<AttachmentSignedUrl> get copyWith => _$AttachmentSignedUrlCopyWithImpl<AttachmentSignedUrl>(this as AttachmentSignedUrl, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is AttachmentSignedUrl&&(identical(other.url, url) || other.url == url)&&const DeepCollectionEquality().equals(other.raw, raw));
}


@override
int get hashCode => Object.hash(runtimeType,url,const DeepCollectionEquality().hash(raw));

@override
String toString() {
  return 'AttachmentSignedUrl(url: $url, raw: $raw)';
}
...
/// @nodoc
abstract mixin class $AttachmentSignedUrlCopyWith<$Res>  {
  factory $AttachmentSignedUrlCopyWith(AttachmentSignedUrl value, $Res Function(AttachmentSignedUrl) _then) = _$AttachmentSignedUrlCopyWithImpl;
@useResult
$Res call({
 String url, Map<String, dynamic> raw
});
...
/// @nodoc
class _$AttachmentSignedUrlCopyWithImpl<$Res>
    implements $AttachmentSignedUrlCopyWith<$Res> {
  _$AttachmentSignedUrlCopyWithImpl(this._self, this._then);

  final AttachmentSignedUrl _self;
  final $Res Function(AttachmentSignedUrl) _then;

/// Create a copy of AttachmentSignedUrl
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? url = null,Object? raw = null,}) {
  return _then(_self.copyWith(
...
extension AttachmentSignedUrlPatterns on AttachmentSignedUrl {
/// A variant of `map` that fallback to returning `orElse`.
///
/// It is equivalent to doing:
/// ```dart
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _AttachmentSignedUrl value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _AttachmentSignedUrl() when $default != null:
return $default(_that);case _:
  return orElse();
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _AttachmentSignedUrl value)  $default,){
final _that = this;
switch (_that) {
case _AttachmentSignedUrl():
return $default(_that);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _AttachmentSignedUrl value)?  $default,){
final _that = this;
switch (_that) {
case _AttachmentSignedUrl() when $default != null:
return $default(_that);case _:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String url,  Map<String, dynamic> raw)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _AttachmentSignedUrl() when $default != null:
return $default(_that.url,_that.raw);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String url,  Map<String, dynamic> raw)  $default,) {final _that = this;
switch (_that) {
case _AttachmentSignedUrl():
return $default(_that.url,_that.raw);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String url,  Map<String, dynamic> raw)?  $default,) {final _that = this;
switch (_that) {
case _AttachmentSignedUrl() when $default != null:
return $default(_that.url,_that.raw);case _:
  return null;
...
class _AttachmentSignedUrl implements AttachmentSignedUrl {
  const _AttachmentSignedUrl({required this.url, required final  Map<String, dynamic> raw}): _raw = raw;
...
@override @JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
_$AttachmentSignedUrlCopyWith<_AttachmentSignedUrl> get copyWith => __$AttachmentSignedUrlCopyWithImpl<_AttachmentSignedUrl>(this, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _AttachmentSignedUrl&&(identical(other.url, url) || other.url == url)&&const DeepCollectionEquality().equals(other._raw, _raw));
}


@override
int get hashCode => Object.hash(runtimeType,url,const DeepCollectionEquality().hash(_raw));
...
/// @nodoc
abstract mixin class _$AttachmentSignedUrlCopyWith<$Res> implements $AttachmentSignedUrlCopyWith<$Res> {
  factory _$AttachmentSignedUrlCopyWith(_AttachmentSignedUrl value, $Res Function(_AttachmentSignedUrl) _then) = __$AttachmentSignedUrlCopyWithImpl;
@override @useResult
$Res call({
 String url, Map<String, dynamic> raw
});
...
/// @nodoc
class __$AttachmentSignedUrlCopyWithImpl<$Res>
    implements _$AttachmentSignedUrlCopyWith<$Res> {
  __$AttachmentSignedUrlCopyWithImpl(this._self, this._then);

  final _AttachmentSignedUrl _self;
  final $Res Function(_AttachmentSignedUrl) _then;

/// Create a copy of AttachmentSignedUrl
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? url = null,Object? raw = null,}) {
  return _then(_AttachmentSignedUrl(
url: null == url ? _self.url : url // ignore: cast_nullable_to_non_nullable
as String,raw: null == raw ? _self._raw : raw // ignore: cast_nullable_to_non_nullable
as Map<String, dynamic>,
  ));
