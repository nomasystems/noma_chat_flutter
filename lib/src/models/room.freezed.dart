...
class _ChatRoom extends ChatRoom {
  const _ChatRoom({required this.id, this.owner, this.name, this.subject, this.audience = RoomAudience.contacts, this.allowInvitations = false, final  List<String> members = const <String>[], this.publicToken, this.avatarUrl, final  Map<String, dynamic>? custom}): _members = members,_custom = custom,super._();
