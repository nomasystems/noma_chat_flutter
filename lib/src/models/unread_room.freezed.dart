...
mixin _$UnreadRoom {
 ...
 String get roomId; int get unreadMessages; String? get lastMessage; DateTime? get lastMessageTime; String? get lastMessageUserId; String? get lastMessageId; MessageType? get lastMessageType; String? get lastMessageMimeType; String? get lastMessageFileName; int? get lastMessageDurationMs; bool get lastMessageIsDeleted; String? get lastMessageReactionEmoji; ReceiptStatus? get lastMessageReceipt; String? get name; String? get avatarUrl; String? get type; int? get memberCount; RoomRole? get userRole; bool get muted; bool get pinned; bool get hidden;
...
@override
int get hashCode => Object.hashAll([runtimeType,roomId,unreadMessages,lastMessage,lastMessageTime,lastMessageUserId,lastMessageId,lastMessageType,lastMessageMimeType,lastMessageFileName,lastMessageDurationMs,lastMessageIsDeleted,lastMessageReactionEmoji,lastMessageReceipt,name,avatarUrl,type,memberCount,userRole,muted,pinned,hidden]);

@override
String toString() {
  return 'UnreadRoom(roomId: $roomId, unreadMessages: $unreadMessages, lastMessage: $lastMessage, lastMessageTime: $lastMessageTime, lastMessageUserId: $lastMessageUserId, lastMessageId: $lastMessageId, lastMessageType: $lastMessageType, lastMessageMimeType: $lastMessageMimeType, lastMessageFileName: $lastMessageFileName, lastMessageDurationMs: $lastMessageDurationMs, lastMessageIsDeleted: $lastMessageIsDeleted, lastMessageReactionEmoji: $lastMessageReactionEmoji, lastMessageReceipt: $lastMessageReceipt, name: $name, avatarUrl: $avatarUrl, type: $type, memberCount: $memberCount, userRole: $userRole, muted: $muted, pinned: $pinned, hidden: $hidden)';
}
...
@useResult
$Res call({
 String roomId, int unreadMessages, String? lastMessage, DateTime? lastMessageTime, String? lastMessageUserId, String? lastMessageId, MessageType? lastMessageType, String? lastMessageMimeType, String? lastMessageFileName, int? lastMessageDurationMs, bool lastMessageIsDeleted, String? lastMessageReactionEmoji, ReceiptStatus? lastMessageReceipt, String? name, String? avatarUrl, String? type, int? memberCount, RoomRole? userRole, bool muted, bool pinned, bool hidden
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String roomId,  int unreadMessages,  String? lastMessage,  DateTime? lastMessageTime,  String? lastMessageUserId,  String? lastMessageId,  MessageType? lastMessageType,  String? lastMessageMimeType,  String? lastMessageFileName,  int? lastMessageDurationMs,  bool lastMessageIsDeleted,  String? lastMessageReactionEmoji,  ReceiptStatus? lastMessageReceipt,  String? name,  String? avatarUrl,  String? type,  int? memberCount,  RoomRole? userRole,  bool muted,  bool pinned,  bool hidden)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _UnreadRoom() when $default != null:
return $default(_that.roomId,_that.unreadMessages,_that.lastMessage,_that.lastMessageTime,_that.lastMessageUserId,_that.lastMessageId,_that.lastMessageType,_that.lastMessageMimeType,_that.lastMessageFileName,_that.lastMessageDurationMs,_that.lastMessageIsDeleted,_that.lastMessageReactionEmoji,_that.lastMessageReceipt,_that.name,_that.avatarUrl,_that.type,_that.memberCount,_that.userRole,_that.muted,_that.pinned,_that.hidden);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String roomId,  int unreadMessages,  String? lastMessage,  DateTime? lastMessageTime,  String? lastMessageUserId,  String? lastMessageId,  MessageType? lastMessageType,  String? lastMessageMimeType,  String? lastMessageFileName,  int? lastMessageDurationMs,  bool lastMessageIsDeleted,  String? lastMessageReactionEmoji,  ReceiptStatus? lastMessageReceipt,  String? name,  String? avatarUrl,  String? type,  int? memberCount,  RoomRole? userRole,  bool muted,  bool pinned,  bool hidden)  $default,) {final _that = this;
switch (_that) {
case _UnreadRoom():
return $default(_that.roomId,_that.unreadMessages,_that.lastMessage,_that.lastMessageTime,_that.lastMessageUserId,_that.lastMessageId,_that.lastMessageType,_that.lastMessageMimeType,_that.lastMessageFileName,_that.lastMessageDurationMs,_that.lastMessageIsDeleted,_that.lastMessageReactionEmoji,_that.lastMessageReceipt,_that.name,_that.avatarUrl,_that.type,_that.memberCount,_that.userRole,_that.muted,_that.pinned,_that.hidden);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String roomId,  int unreadMessages,  String? lastMessage,  DateTime? lastMessageTime,  String? lastMessageUserId,  String? lastMessageId,  MessageType? lastMessageType,  String? lastMessageMimeType,  String? lastMessageFileName,  int? lastMessageDurationMs,  bool lastMessageIsDeleted,  String? lastMessageReactionEmoji,  ReceiptStatus? lastMessageReceipt,  String? name,  String? avatarUrl,  String? type,  int? memberCount,  RoomRole? userRole,  bool muted,  bool pinned,  bool hidden)?  $default,) {final _that = this;
switch (_that) {
case _UnreadRoom() when $default != null:
return $default(_that.roomId,_that.unreadMessages,_that.lastMessage,_that.lastMessageTime,_that.lastMessageUserId,_that.lastMessageId,_that.lastMessageType,_that.lastMessageMimeType,_that.lastMessageFileName,_that.lastMessageDurationMs,_that.lastMessageIsDeleted,_that.lastMessageReactionEmoji,_that.lastMessageReceipt,_that.name,_that.avatarUrl,_that.type,_that.memberCount,_that.userRole,_that.muted,_that.pinned,_that.hidden);case _:
  return null;
...
class _UnreadRoom implements UnreadRoom {
  const _UnreadRoom({required this.roomId, required this.unreadMessages, this.lastMessage, this.lastMessageTime, this.lastMessageUserId, this.lastMessageId, this.lastMessageType, this.lastMessageMimeType, this.lastMessageFileName, this.lastMessageDurationMs, this.lastMessageIsDeleted = false, this.lastMessageReactionEmoji, this.lastMessageReceipt, this.name, this.avatarUrl, this.type, this.memberCount, this.userRole, this.muted = false, this.pinned = false, this.hidden = false});
