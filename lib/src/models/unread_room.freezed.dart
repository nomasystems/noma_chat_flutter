...
/// without fetching message bodies.
 int get unreadMentions;/// Text of the last message as its sender wrote it. Never a label or a
...
/// paint time.
 String? get lastMessage; DateTime? get lastMessageTime; String? get lastMessageUserId; String? get lastMessageId; MessageType? get lastMessageType; String? get lastMessageMimeType; String? get lastMessageFileName; int? get lastMessageDurationMs; bool get lastMessageIsDeleted;/// `true` when the last message is a system notice rather than something
/// a person wrote. Feeds `RoomListItem.lastMessageIsSystem` on
/// rehydration so the row keeps dropping the sender prefix across
/// restarts.
 bool get lastMessageIsSystem; String? get lastMessageReactionEmoji;/// Text of the message the last reaction was aimed at, truncated to 30
/// grapheme clusters, quoted inside the reaction preview.
 String? get lastMessageReactionTargetText;/// Type of the message the last reaction was aimed at, so a text-less
/// one can be quoted by its label in the reader's own language.
 MessageType? get lastMessageReactionTargetType; ReceiptStatus? get lastMessageReceipt; String? get name; String? get avatarUrl; String? get type; int? get memberCount; RoomRole? get userRole; bool get muted;/// When the notification mute expires (UTC). `null` means a permanent
/// mute (or not muted at all — check [muted]). Lets the UI show "muted
/// until 14:00" and the consumer re-derive [muted] after expiry.
 DateTime? get muteUntil; bool get pinned; bool get hidden; bool get selfMuted;/// Who may post into this room, as the listing projection reports it in
...
/// [RoomWritePolicy.members].
 RoomWritePolicy get writePolicy;/// Host-defined data mirrored from the room's `custom` map (e.g. a
/// support room's `support` flag). The room-listing projection does not
/// emit `custom` — only the room detail does — so a listing pass alone
/// leaves this `null`; enrichment degrades to the room detail, then to
/// this snapshot, then to whatever is already painted.
...
@useResult
$Res call({
 String roomId, int unreadMessages, int unreadMentions, String? lastMessage, DateTime? lastMessageTime, String? lastMessageUserId, String? lastMessageId, MessageType? lastMessageType, String? lastMessageMimeType, String? lastMessageFileName, int? lastMessageDurationMs, bool lastMessageIsDeleted, bool lastMessageIsSystem, String? lastMessageReactionEmoji, String? lastMessageReactionTargetText, MessageType? lastMessageReactionTargetType, ReceiptStatus? lastMessageReceipt, String? name, String? avatarUrl, String? type, int? memberCount, RoomRole? userRole, bool muted, DateTime? muteUntil, bool pinned, bool hidden, bool selfMuted, RoomWritePolicy writePolicy, Map<String, dynamic>? custom
});
...
as bool,lastMessageIsSystem: null == lastMessageIsSystem ? _self.lastMessageIsSystem : lastMessageIsSystem // ignore: cast_nullable_to_non_nullable
...
as String?,lastMessageReactionTargetText: freezed == lastMessageReactionTargetText ? _self.lastMessageReactionTargetText : lastMessageReactionTargetText // ignore: cast_nullable_to_non_nullable
as String?,lastMessageReactionTargetType: freezed == lastMessageReactionTargetType ? _self.lastMessageReactionTargetType : lastMessageReactionTargetType // ignore: cast_nullable_to_non_nullable
as MessageType?,lastMessageReceipt: freezed == lastMessageReceipt ? _self.lastMessageReceipt : lastMessageReceipt // ignore: cast_nullable_to_non_nullable
...
as RoomWritePolicy,custom: freezed == custom ? _self.custom : custom // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String roomId,  int unreadMessages,  int unreadMentions,  String? lastMessage,  DateTime? lastMessageTime,  String? lastMessageUserId,  String? lastMessageId,  MessageType? lastMessageType,  String? lastMessageMimeType,  String? lastMessageFileName,  int? lastMessageDurationMs,  bool lastMessageIsDeleted,  bool lastMessageIsSystem,  String? lastMessageReactionEmoji,  String? lastMessageReactionTargetText,  MessageType? lastMessageReactionTargetType,  ReceiptStatus? lastMessageReceipt,  String? name,  String? avatarUrl,  String? type,  int? memberCount,  RoomRole? userRole,  bool muted,  DateTime? muteUntil,  bool pinned,  bool hidden,  bool selfMuted,  RoomWritePolicy writePolicy,  Map<String, dynamic>? custom)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _UnreadRoom() when $default != null:
return $default(_that.roomId,_that.unreadMessages,_that.unreadMentions,_that.lastMessage,_that.lastMessageTime,_that.lastMessageUserId,_that.lastMessageId,_that.lastMessageType,_that.lastMessageMimeType,_that.lastMessageFileName,_that.lastMessageDurationMs,_that.lastMessageIsDeleted,_that.lastMessageIsSystem,_that.lastMessageReactionEmoji,_that.lastMessageReactionTargetText,_that.lastMessageReactionTargetType,_that.lastMessageReceipt,_that.name,_that.avatarUrl,_that.type,_that.memberCount,_that.userRole,_that.muted,_that.muteUntil,_that.pinned,_that.hidden,_that.selfMuted,_that.writePolicy,_that.custom);case _:
  return orElse();
...
class _UnreadRoom implements UnreadRoom {
  const _UnreadRoom({required this.roomId, required this.unreadMessages, this.unreadMentions = 0, this.lastMessage, this.lastMessageTime, this.lastMessageUserId, this.lastMessageId, this.lastMessageType, this.lastMessageMimeType, this.lastMessageFileName, this.lastMessageDurationMs, this.lastMessageIsDeleted = false, this.lastMessageIsSystem = false, this.lastMessageReactionEmoji, this.lastMessageReactionTargetText, this.lastMessageReactionTargetType, this.lastMessageReceipt, this.name, this.avatarUrl, this.type, this.memberCount, this.userRole, this.muted = false, this.muteUntil, this.pinned = false, this.hidden = false, this.selfMuted = false, this.writePolicy = RoomWritePolicy.members, final  Map<String, dynamic>? custom}): _custom = custom;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _UnreadRoom&&(identical(other.roomId, roomId) || other.roomId == roomId)&&(identical(other.unreadMessages, unreadMessages) || other.unreadMessages == unreadMessages)&&(identical(other.unreadMentions, unreadMentions) || other.unreadMentions == unreadMentions)&&(identical(other.lastMessage, lastMessage) || other.lastMessage == lastMessage)&&(identical(other.lastMessageTime, lastMessageTime) || other.lastMessageTime == lastMessageTime)&&(identical(other.lastMessageUserId, lastMessageUserId) || other.lastMessageUserId == lastMessageUserId)&&(identical(other.lastMessageId, lastMessageId) || other.lastMessageId == lastMessageId)&&(identical(other.lastMessageType, lastMessageType) || other.lastMessageType == lastMessageType)&&(identical(other.lastMessageMimeType, lastMessageMimeType) || other.lastMessageMimeType == lastMessageMimeType)&&(identical(other.lastMessageFileName, lastMessageFileName) || other.lastMessageFileName == lastMessageFileName)&&(identical(other.lastMessageDurationMs, lastMessageDurationMs) || other.lastMessageDurationMs == lastMessageDurationMs)&&(identical(other.lastMessageIsDeleted, lastMessageIsDeleted) || other.lastMessageIsDeleted == lastMessageIsDeleted)&&(identical(other.lastMessageIsSystem, lastMessageIsSystem) || other.lastMessageIsSystem == lastMessageIsSystem)&&(identical(other.lastMessageReactionEmoji, lastMessageReactionEmoji) || other.lastMessageReactionEmoji == lastMessageReactionEmoji)&&(identical(other.lastMessageReactionTargetText, lastMessageReactionTargetText) || other.lastMessageReactionTargetText == lastMessageReactionTargetText)&&(identical(other.lastMessageReactionTargetType, lastMessageReactionTargetType) || other.lastMessageReactionTargetType == lastMessageReactionTargetType)&&(identical(other.lastMessageReceipt, lastMessageReceipt) || other.lastMessageReceipt == lastMessageReceipt)&&(identical(other.name, name) || other.name == name)&&(identical(other.avatarUrl, avatarUrl) || other.avatarUrl == avatarUrl)&&(identical(other.type, type) || other.type == type)&&(identical(other.memberCount, memberCount) || other.memberCount == memberCount)&&(identical(other.userRole, userRole) || other.userRole == userRole)&&(identical(other.muted, muted) || other.muted == muted)&&(identical(other.muteUntil, muteUntil) || other.muteUntil == muteUntil)&&(identical(other.pinned, pinned) || other.pinned == pinned)&&(identical(other.hidden, hidden) || other.hidden == hidden)&&(identical(other.selfMuted, selfMuted) || other.selfMuted == selfMuted)&&(identical(other.writePolicy, writePolicy) || other.writePolicy == writePolicy)&&const DeepCollectionEquality().equals(other._custom, _custom));
}


@override
int get hashCode => Object.hashAll([runtimeType,roomId,unreadMessages,unreadMentions,lastMessage,lastMessageTime,lastMessageUserId,lastMessageId,lastMessageType,lastMessageMimeType,lastMessageFileName,lastMessageDurationMs,lastMessageIsDeleted,lastMessageIsSystem,lastMessageReactionEmoji,lastMessageReactionTargetText,lastMessageReactionTargetType,lastMessageReceipt,name,avatarUrl,type,memberCount,userRole,muted,muteUntil,pinned,hidden,selfMuted,writePolicy,const DeepCollectionEquality().hash(_custom)]);
...
as bool,selfMuted: null == selfMuted ? _self.selfMuted : selfMuted // ignore: cast_nullable_to_non_nullable
as bool,writePolicy: null == writePolicy ? _self.writePolicy : writePolicy // ignore: cast_nullable_to_non_nullable
as RoomWritePolicy,custom: freezed == custom ? _self._custom : custom // ignore: cast_nullable_to_non_nullable
as Map<String, dynamic>?,
  ));
}
