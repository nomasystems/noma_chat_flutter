...
@override
int get hashCode => Object.hashAll([runtimeType,roomId,unreadMessages,unreadMentions,lastMessage,lastMessageTime,lastMessageUserId,lastMessageId,lastMessageType,lastMessageMimeType,lastMessageFileName,lastMessageDurationMs,lastMessageIsDeleted,lastMessageReactionEmoji,lastMessageReactionTargetText,lastMessageReactionTargetType,lastMessageReceipt,name,avatarUrl,type,memberCount,userRole,muted,muteUntil,pinned,hidden,selfMuted]);

@override
String toString() {
  return 'UnreadRoom(roomId: $roomId, unreadMessages: $unreadMessages, unreadMentions: $unreadMentions, lastMessage: $lastMessage, lastMessageTime: $lastMessageTime, lastMessageUserId: $lastMessageUserId, lastMessageId: $lastMessageId, lastMessageType: $lastMessageType, lastMessageMimeType: $lastMessageMimeType, lastMessageFileName: $lastMessageFileName, lastMessageDurationMs: $lastMessageDurationMs, lastMessageIsDeleted: $lastMessageIsDeleted, lastMessageReactionEmoji: $lastMessageReactionEmoji, lastMessageReactionTargetText: $lastMessageReactionTargetText, lastMessageReactionTargetType: $lastMessageReactionTargetType, lastMessageReceipt: $lastMessageReceipt, name: $name, avatarUrl: $avatarUrl, type: $type, memberCount: $memberCount, userRole: $userRole, muted: $muted, muteUntil: $muteUntil, pinned: $pinned, hidden: $hidden, selfMuted: $selfMuted)';
}
...
switch (_that) {
case _UnreadRoom() when $default != null:
return $default(_that.roomId,_that.unreadMessages,_that.unreadMentions,_that.lastMessage,_that.lastMessageTime,_that.lastMessageUserId,_that.lastMessageId,_that.lastMessageType,_that.lastMessageMimeType,_that.lastMessageFileName,_that.lastMessageDurationMs,_that.lastMessageIsDeleted,_that.lastMessageReactionEmoji,_that.lastMessageReactionTargetText,_that.lastMessageReactionTargetType,_that.lastMessageReceipt,_that.name,_that.avatarUrl,_that.type,_that.memberCount,_that.userRole,_that.muted,_that.muteUntil,_that.pinned,_that.hidden,_that.selfMuted);case _:
  return orElse();
...
class _UnreadRoom implements UnreadRoom {
  const _UnreadRoom({required this.roomId, required this.unreadMessages, this.unreadMentions = 0, this.lastMessage, this.lastMessageTime, this.lastMessageUserId, this.lastMessageId, this.lastMessageType, this.lastMessageMimeType, this.lastMessageFileName, this.lastMessageDurationMs, this.lastMessageIsDeleted = false, this.lastMessageReactionEmoji, this.lastMessageReactionTargetText, this.lastMessageReactionTargetType, this.lastMessageReceipt, this.name, this.avatarUrl, this.type, this.memberCount, this.userRole, this.muted = false, this.muteUntil, this.pinned = false, this.hidden = false, this.selfMuted = false});
