...
class _UnreadRoom implements UnreadRoom {
  const _UnreadRoom({required this.roomId, required this.unreadMessages, this.unreadMentions = 0, this.lastMessage, this.lastMessageTime, this.lastMessageUserId, this.lastMessageId, this.lastMessageType, this.lastMessageMimeType, this.lastMessageFileName, this.lastMessageDurationMs, this.lastMessageIsDeleted = false, this.lastMessageIsSystem = false, this.lastMessageReactionEmoji, this.lastMessageReactionTargetText, this.lastMessageReactionTargetType, this.lastMessageReceipt, this.name, this.avatarUrl, this.type, this.memberCount, this.userRole, this.muted = false, this.muteUntil, this.pinned = false, this.hidden = false, this.selfMuted = false, this.writePolicy = RoomWritePolicy.members});
