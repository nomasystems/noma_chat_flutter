...
void main() {
  ...
  test('a queued sendMessage does not self-duplicate across two consecutive '
      'drain failures for the same op (R2-15)', () async {
    when(
    ...
    expect(
      ...
      1,
      reason:
          'a single failed drain attempt must leave exactly one '
    ...
    expect(
      ...
      1,
      reason:
          'two consecutive failed drain attempts of the same op must '
