...
void main() {
  ...
  testWidgets('isPending shows the clock icon', (tester) async {
    await tester.pumpWidget(
      wrap(
        MessageBubble(message: outgoing(), isOutgoing: true, isPending: true),
      ),
    );
  ...
  testWidgets('isDeleted renders the "message deleted" placeholder', (
    ...
    await tester.pumpWidget(
      wrap(MessageBubble(message: outgoing(isDeleted: true), isOutgoing: true)),
    );
  ...
  testWidgets('forwarded message wraps in a ForwardedBubble', (tester) async {
    await tester.pumpWidget(
      wrap(
        MessageBubble(message: outgoing(isForwarded: true), isOutgoing: true),
      ),
    );
