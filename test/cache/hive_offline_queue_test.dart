...
void main() {
  ...
  group('offline queue', () {
    ...
    test('two overlapping saveOfflineQueue calls do not lose the larger '
        'queue to the smaller one\'s trim step', () async {
    ...
    test('many concurrent saveOfflineQueue calls converge to a consistent '
        'final state matching the last call issued', () async {
